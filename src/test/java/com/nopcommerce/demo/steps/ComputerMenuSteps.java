...
public class ComputerMenuSteps {
    ...
    public void iClickOnAddToCartOfProductBuildYourOwnComputer() throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void iShouldSeePrice$(int arg0, int arg1, int arg2) throws InterruptedException {
        ...
        String actualPrice = new AddToCartPage().verifyThePrice();
        Assert.assertEquals(expectedPrice, actualPrice, "Not displayed");
    }
    ...
    public void iShouldSeeTextThankYou() {
        ...
        String actual = new GuestCheckOutPage().verifyThankYouMessage();
        Assert.assertEquals(expected, actual, "Not displayed");
    }
